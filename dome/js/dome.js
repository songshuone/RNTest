		 ...
		 {title:'nevers',icon:require('./img/home_press.png'),show:'never'}]}
                ...
                <ScrollView style={{backgroundColor:'#999'}}>
                    <View style={styles.container}>
						...
						width:340,}}>
                            <Text
                                style={{fontSize:15,color:'#000',marginLeft:10,marginTop:5,marginBottom:5}}>Auto-focus</Text>
                        </View>
                        <View
                            style={{
							backgroundColor:'#888',
                        ...
                        <View
                            style={{marginTop:10,justifyContent:'center',alignItems:'center',marginLeft:10,marginRight:10,backgroundColor:'grey',width:340,}}>
                            <Text style={{fontSize:15,color:'#000',alignSelf:'center',margin:5,}}>Live Re-Write
                                maxLength</Text>

                        </View>
                        <View
                            style={{ flexDirection:'row',alignItems:'center', backgroundColor:'#f2f2f2' ,width:340,height:80,marginLeft:10,marginRight:10,}}>
                            <View
                                style={{borderColor:'grey',borderWidth:1,flex:8,marginLeft:10,height:55,marginRight:10,}}>
                        ...
                        <View
                            style={{marginTop:10,justifyContent:'center',alignItems:'center',marginLeft:10,marginRight:10,backgroundColor:'grey',width:340,}}>
                            <Text style={{fontSize:15,color:'#000',alignSelf:'center',margin:5,}}>Live Re-Write (no
                                space allows)</Text>
